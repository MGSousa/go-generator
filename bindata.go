...
func publicIndexHtml() (*asset, error) {
	...
	info := bindataFileInfo{name: "public/index.html", size: 142, mode: os.FileMode(420), modTime: time.Unix(1604335331, 0)}
